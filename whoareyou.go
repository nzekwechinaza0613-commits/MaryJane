...
func main() {
	...
	for _, char := range Firstname {
		if (char >= 'A' && char <= 'Z') || (char >= 'a' && char <= 'z') {
			fmt.Println(style("ERROR; ONLY ALPHABETS WITHOUT SPACES ARE ALLOWED ❗❗❗", "\033[1;31m",""))
			fmt.Println(style("TRY AGAIN", "\033[1;31m",""))
			fmt.Println(" ")
			fmt.Print("PLEASE RE-ENTER YOUR FIRSTNAME: ")
			goto start1
	...
	fmt.Println(style("ADMIN PASSWORD REQUIRED TO PROCEED", "\033[1;33m",""))
	fmt.Println(" ")
	var Password string
	for attempt := 1; attempt <= maxretry; attempt++ {
	fmt.Println(style("PLEASE ENTER YOUR 6-DIGIT PASSWORD: ", "\033[1;33m",""))
	...
	fmt.Println(" ")
	fmt.Printf(style("SPECIAL GUEST DETECTED! Hello %s %s!,WELCOME TO 𝗛 𝗘 𝗔 𝗩 𝗘 𝗡 👑🕊️ \n", "\033[1;32m",""), Firstname, Lastname)
	fmt.Println(style("YOU HAVE BEEN GRANTED ACCESS DO ENJOY YOUR STAY HERE💫", "\033[1;32m",""))
	fmt.Println("==========================================")
	return
		}
	}
